...
const CREDIT_PACKS: Record<string, { credits: number; amount: number; label: string; description: string }> = {
  ...
  'author':    { credits: 300,  amount: 6300,  label: '300 Credits',  description: 'Good for 3–4 trailers. Great for active authors.' },
  'pro':       { credits: 700,  amount: 14000, label: '700 Credits',  description: 'Good for 8+ trailers. Best rate per credit.' },
  'audiobook': { credits: 1500, amount: 30000, label: '1500 Credits', description: 'Exactly enough for one full-cast audiobook, or 10 standard trailers.' },
}
